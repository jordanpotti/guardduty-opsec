...
For each GuardDuty Findings, there are opsec considerations one should take to avoid triggering the alert. 

This is definitely not an all inclusive list, so please make a pull request, or open an issue!
